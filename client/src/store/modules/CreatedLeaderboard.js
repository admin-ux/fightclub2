...
const getters = {
  queriedCreatedLeaderboardByLeaderboardID: (state) =>
    state.createdLeaderboardObj,
...
const actions = {
  ...
  async createdLeaderboardByLeaderboardID({ commit }, leaderboardID) {
    try {
      ...
      const response = await axios.get(url + "/createdleaderboard/info", {
  ...
  async createdLeaderboardUsersList({ commit }, leaderboardID) {
    try {
      ...
      const response = await axios.get(url + "/createdleaderboard/userList", {
        params: leaderboardID,
      });
  ...
  async createdLeaderboardCreate({ commit }, newCreatedLeaderboard) {
    try {
      ...
      const response = await axios.post(
        url + "/createdleaderboard",
        newCreatedLeaderboard
      );
  ...
  async addSingleUserTocreatedLeaderboard(
    { commit },
    editedCreatedLeaderboardUserList
  ) {
    try {
      console.log("In vuex");
      ...
      const response = await axios.put(
        url + "/createdleaderboard/userIDList",
        editedCreatedLeaderboardUserList
      );
